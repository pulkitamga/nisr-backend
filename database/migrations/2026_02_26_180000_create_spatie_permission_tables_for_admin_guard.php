...
return new class extends Migration
{
    public function up(): void
    {
        ...
        } elseif (!Schema::hasColumn($tableNames['roles'], 'status')) {
        ...
        if (!Schema::hasTable($tableNames['model_has_permissions'])) {
            Schema::create($tableNames['model_has_permissions'], static function (Blueprint $table) use ($tableNames, $pivotPermission, $modelKey) {
        ...
        if (!Schema::hasTable($tableNames['model_has_roles'])) {
            Schema::create($tableNames['model_has_roles'], static function (Blueprint $table) use ($tableNames, $pivotRole, $modelKey) {
    ...
    public function down(): void
    {
        ...
        if (Schema::hasColumn($tableNames['roles'], 'status')) {
            Schema::table($tableNames['roles'], static function (Blueprint $table) {
