...
enum StockRequest
{
    const ADD = [
        URI => 'add',
        VIEW => 'admin-views.stock-request.add-new'
    ];

    const LIST = [
        URI => 'list',
        VIEW => 'admin-views.stock-request.list'
    ];

    const UPDATE = [
        URI => 'update',
        VIEW => 'admin-views.stock-request.edit',
    ];

    const VIEW = [
        URI => 'view',
        VIEW => 'admin-views.stock-request.view',
        ROUTE => 'admin-views.stock-request.view'
    ];

    const SEARCH = [
        URI => 'search-products',
        VIEW => 'admin-views.stock-request.partials._search-product'
    ];
    ...
    const BRANCH_PRODUCT_STOCK = [
        URI => 'get-product-stock',
        VIEW => ''
    ];
    const DOWNLOAD_CSV = [
        URI => 'download-csv',
    ...
    const TRANSFER_REQUEST_LIST = [
        ...
        VIEW => 'admin-views.stock-request.transfer-request-list'
    ];
