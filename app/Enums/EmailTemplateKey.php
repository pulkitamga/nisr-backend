...
enum EmailTemplateKey
{
    ...
    const PRODUCT_SEND = 'product-send';
    const PAYMENT_RECEIVED = 'payment-received';
    const QUOTATION_SEND = 'quotation-send';
    const PURCHASE_ORDER_RECEIVED = 'purchase-order-recevied';
    ...
    const WHOLESALER_EMAIL_LIST = [
        EmailTemplateKey::REGISTRATION,
        EmailTemplateKey::REGISTRATION_APPROVED,
        EmailTemplateKey::ACCOUNT_SUSPENDED,
        EmailTemplateKey::ACCOUNT_ACTIVATION,
        EmailTemplateKey::FORGET_PASSWORD,
        EmailTemplateKey::QUOTATION_SEND,
        EmailTemplateKey::PURCHASE_ORDER_RECEIVED,
        EmailTemplateKey::PRODUCT_SEND,
