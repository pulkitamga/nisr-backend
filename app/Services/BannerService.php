...
class BannerService
{
    ...
    public function getProcessedData(object $request, string $image = null): array
    {
        ...
        return [
            ...
            'title' => is_array($request['title'] ?? null) ? $request['title'][getDefaultLanguageIndex($request)] : $request['title'],
            'sub_title' => is_array($request['sub_title'] ?? null) ? $request['sub_title'][getDefaultLanguageIndex($request)] : $request['sub_title'],
            'button_text' => is_array($request['button_text'] ?? null) ? $request['button_text'][getDefaultLanguageIndex($request)] : $request['button_text'],
