...
class Order extends Model
{
    ...
    {
        return $this->belongsTo(Branch::class, 'transfer_from_branch');
    }

    public function pickupBranch(): BelongsTo
    {
        return $this->belongsTo(Branch::class, 'pickup_from_branch');
    }
