            ...
            try {
                if (Schema::hasTable('business_settings')) {
                    ...
                    $web_config = [
                        ...
                        'warranty_auto_approve_off_platform' => getWebConfig(name: 'warranty_auto_approve_off_platform'),
                        'warranty_agent_email' => getWebConfig(name: 'warranty_agent_email'),
                        'warranty_sla_first_response' => getWebConfig(name: 'warranty_sla_first_response') ?? 1,
                        'warranty_sla_decision' => getWebConfig(name: 'warranty_sla_decision') ?? 3,
                    ];
