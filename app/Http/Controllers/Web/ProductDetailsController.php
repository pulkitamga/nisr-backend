...
class ProductDetailsController extends Controller
{
    ...
    public function getDefaultTheme(string $slug): View|RedirectResponse
    {
        ...
        if ($product) {
            ...
            if (!empty($variations) && is_array($variations) && isset($variations[0]['qty'])) {
            ...
            $moreProductFromSeller = $this->productRepo->getWebListWithScope(
                ...
                scope: 'active',
                filters: [
                    'added_by' => $product['added_by'] == 'admin' ? 'in_house' : $product['added_by'],
                    'seller_id' => $product['user_id'],
                    'product_type' => 'physical' // 👈 Add this line here too
                ],
            ...
            $relatedProducts = $this->productRepo->getWebListWithScope(
                ...
                filters: [
                    ...
                    'product_type' => 'physical' // 👈 Add this line
                ],
                whereNotIn: ['id' => [$product['id']]],
