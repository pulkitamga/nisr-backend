...
class ServicesListController extends Controller
{
    ...
    public function default_theme(Request $request): View|JsonResponse|Redirector|RedirectResponse
    {
        ...
        if ($hasFilter) {
            ...
            $productListData = ServiceManager::getServiceListData(request: $request);
        ...
        if ($request->ajax()) {
            return response()->json([
                ...
                'view' => view('web-views.services._ajax-products', compact('products'))->render()
            ], 200);
        }

        return view(VIEW_FILE_NAMES['services_view_page'], [
            'products' => $products,
            'data' => $data,
