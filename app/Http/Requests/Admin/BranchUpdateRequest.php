...
class BranchUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            /*'phone'         => 'required|unique:branches,phone,$branchId|max:20|min:4',
            'email'         => 'required|unique:branches,email,$branchId',*/
            'phone'          => ['required', 
                                    Rule::unique('branches', 'phone')->ignore($branchId), 
                                    'max:20', 
                                    'min:4'
                                ],
            'email'          => ['required', Rule::unique('branches', 'email')->ignore($branchId)
                                ],
