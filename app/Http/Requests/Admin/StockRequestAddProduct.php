...
class StockRequestAddProduct extends FormRequest
{
    use ResponseHandler;
    ...
    public function rules(): array
    {
        return [
            ...
            'products' => 'required|array|min:1', // Ensure the products array is provided
            'products.*.product_id' => 'required|exists:products,id', // Validate product id
            'products.*.category_id' => 'required|exists:categories,id', // Validate product id
            'products.*.product_qty' => 'required|integer|min:1', // Ensure quantity is a positive integer
        ];
    }
