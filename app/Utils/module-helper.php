        ...
        if (isset($paymentData) && $paymentData['is_paid'] == 1) {
            ...
            $data = [
                'request' => [
                    ...
                    'coupon_type' => $additionalData['coupon_type'] ?? null,
                    'address_id' => $additionalData['address_id'] ?? null,
                    'billing_address_id' => $additionalData['billing_address_id'] ?? null,
                    'delivery_type' => $additionalData['delivery_type'] ?? 'delivery',
                    'pickup_branch_id' => $additionalData['pickup_branch_id'] ?? null,
                    'nearest_branch' => $additionalData['nearest_branch'] ?? null,
                    'area_wise_shipping_resolved' => $additionalData['area_wise_shipping_resolved'] ?? null,
