...
class ServiceManager
{
    ...
    public static function getServiceListData($request, $productUserID = null, $productAddedBy = null): mixed
    {

        $productSortBy = $request->get('sort_by');
        $productListData = Product::active()
            ->where('product_type', 'services')
            ->with(['service', 'category', 'reviews', 'rating', 'seller.shop', 'clearanceSale' => function ($query) {
