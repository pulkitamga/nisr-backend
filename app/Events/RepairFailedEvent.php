...
class RepairFailedEvent
{
    ...
    {
        // Internal to tech/agent
        $data = [
            'userName' => 'Technician',
            'subject' => translate('Repair QC Failed'),
            'title' => translate('Re-diagnose claim #') . $this->claim->claim_number,
            'claimNumber' => $this->claim->claim_number,
            'userType' => 'admin',
            'templateName' => 'repair-failed',
        ];
