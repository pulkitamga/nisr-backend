...
// AUTO CLOSE ON CANCEL OR X BUTTON
$(document).on("click", "#toggle-status-modal-cancel-button, .close, .btn-close", function () {
    $("#toggle-status-modal").modal("hide");
});
...
$('.btn-close, .btn-danger-light').on('click', function () {
    $('#toggle-status-modal').modal('hide');
});