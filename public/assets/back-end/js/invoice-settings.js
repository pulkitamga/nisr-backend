...
$('#quotation-image-header').on('change', function () {
    var input = this;
    console.log(input);
    if (input.files && input.files[0]) {
        let reader = new FileReader();
        let inputImage = $('.input_image_header');
        reader.onload = (e) => {
            let imageData = e.target.result;
            input.setAttribute("data-title", "");
            let img = new Image();
...
$('#quotation-image-bg').on('change', function () {
    var input = this;
    console.log(input);
    if (input.files && input.files[0]) {
        let reader = new FileReader();
        let inputImage = $('.input_image_bg');
        reader.onload = (e) => {
            let imageData = e.target.result;
            input.setAttribute("data-title", "");
            let img = new Image();
...
$('#quotation-image-footer').on('change', function () {
    var input = this;
    console.log(input);
    if (input.files && input.files[0]) {
        let reader = new FileReader();
        let inputImage = $('.input_image_footer');
        reader.onload = (e) => {
            let imageData = e.target.result;
            input.setAttribute("data-title", "");
            let img = new Image();
