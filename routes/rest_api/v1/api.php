...
Route::post('/decrypt', [EncryptionController::class, 'decryptFile'])->name('decrypt');
    ...
    Route::prefix('pages')->group(function () {
        ...
        Route::get('terms', [PageApiController::class, 'termsAndConditions']);
    });
    ...
    Route::prefix('customer')->group(function () {
        Route::controller(CustomerController::class)->group(function () {
            ...
            Route::get('get-restricted-state-list', 'get_restricted_state_list');
            Route::get('get-restricted-city-list', 'get_restricted_city_list');
            Route::get('get-restricted-area-list', 'get_restricted_area_list');

            Route::get('get-billing-country-list', 'get_billing_country_list');
            Route::get('get-billing-state-list', 'billing_state_list');
            Route::get('get-billing-city-list', 'billing_city_list');
            Route::get('get-billing-area-list', 'billing_area_list');
    ...
    Route::group(['prefix' => 'cart', 'middleware' => 'apiGuestCheck'], function () {
        Route::controller(CartController::class)->group(function () {
            ...
            Route::post('update-shipping-cost', 'updateShippingCost');
            Route::put('update-exchange-charge', 'updateExchangeCharges');
            Route::put('update-installation-charge', 'updateInstallationCharges');
    ...
    Route::group(['middleware' => 'apiGuestCheck'], function () {
        ...
        Route::group(['prefix' => 'customer'], function () {
            ...
            Route::get('/orders/{id}/track', [TrackingController::class, 'trackOrder']);
            Route::post('/orders/track', [TrackingController::class, 'trackByNumber']);
            ...
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::get('pickup-branches', [OrderController::class, 'getPickupBranches']);
            });
        });
    });
