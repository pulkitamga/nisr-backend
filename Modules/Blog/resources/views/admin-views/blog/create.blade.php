...
<link href="{{ dynamicAsset(path: 'public/assets/back-end/plugins/summernote/summernote.min.css') }}" rel="stylesheet">
   <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/back-end/css/style_neha.css') }}">
        <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/back-end/css/style_neha_scss.css') }}">
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-2">
                                ...
                                <a href="javascript:void(0)" class="user-select-none" data-toggle="modal" data-target="#sidebarCategoryModal">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="writer" id="" value="{{ old('writer') }}" class="form-control" placeholder="{{ translate('Ex') }}: {{ __('Jhon Milar') }}">
                        </div>
                ...
                <div class="d-flex flex-wrap gap-3 justify-content-end mt-4">
                    ...
                    <a class="btn btn--primary-2 save-draft">
                        {{ translate('Save_to_Draft') }}
                    </a>
                    <button type="button" class="btn btn--primary-2 publish" data-bs-toggle="modal" data-bs-target="#toggle-status-publish-modal">
                        {{ translate('Publish') }}
                    </button>
                </div>
            </div>
