                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    ...
                                    <label class="switcher" for="services-product">
                                        <input type="checkbox" class="switcher_input toggle-switch-message" value="1" name="services"
                                               id="services-product" {{ $servicesProduct && $servicesProduct['value'] ? 'checked':'' }}
                                               data-modal-id = "toggle-modal"
                                               data-toggle-id = "services-product"
                                               data-on-image = "digital-product-on.png"
                                               data-off-image = "digital-product-off.png"
                                               data-on-title = "{{translate('want_to_Turn_ON_Services').'?'}}"
                                               data-off-title = "{{translate('want_to_Turn_OFF_Services').'?'}}"
                                               data-on-message = "<p>{{translate('if_enabled_services_are_shown_in_website')}}</p>"
                                               data-off-message = "<p>{{translate('if_disabled_services_are_hide_from_website')}}</p>">
