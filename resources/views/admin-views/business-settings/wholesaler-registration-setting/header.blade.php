...
<div class="content container-fluid">
    ...
    <form action="{{route('admin.business-settings.wholesaler-registration-settings.index')}}" method="post"
                ...
                <div class="form-group d-flex align-items-center gap-3">
                    <label class="switcher mx-auto">
                        <input type="checkbox" class="switcher_input status-toggle"
                            data-type="wholesaler_registration_header" name="is_active" value="1" {{
                        ...
                        <div class="mx-auto max-w-400">
                            ...
                            <div class="custom_upload_input">
                                ...
                                <div class="img_area_with_preview position-absolute z-index-2">
                                    @php($imagePath =
                                    imagePathProcessing(imageData:$wholesalerRegistrationHeader?->image, path:
