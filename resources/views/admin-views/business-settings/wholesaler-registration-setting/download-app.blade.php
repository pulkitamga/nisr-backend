...
<div class="content container-fluid">
    ...
    <form action="{{route('admin.business-settings.wholesaler-registration-settings.download-app')}}" method="post"
            ...
            <div class="card-header">
                ...
                <div class="form-group d-flex align-items-center gap-3">
                    <label class="switcher mx-auto">
                        <input type="checkbox" class="switcher_input status-toggle" data-type="download_wholesaler_app"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control"
                                        value="{{$downloadWholesalerApp?->title}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sub_title" class="form-control"
                                        value="{{$downloadWholesalerApp?->sub_title}}"
                                        placeholder="{{translate('enter_title')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mx-auto max-w-150">
                                    ...
                                    <div class="custom_upload_input">
                                        <input type="file" name="image" class="image-input" data-image-id="view-bp-logo"
                                            accept="image/*">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2">
                                            <img id="view-bp-logo"
                                                src="{{getStorageImages(path:imagePathProcessing(imageData: $downloadWholesalerApp?->image, path: 'vendor-registration-setting'),type: 'backend-banner')}}"
                                                class="bg-white" alt="">
                                        </div>
                                        <div
                                            ...
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                ...
                                                <h5 class="text-muted text-capitalize">{{ translate('upload_image') }}
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card border shadow-none mb-3">
                    <div class="card-body">
                        <div class="row gy-3">
                            <div class="col-lg-6">
                                <div
                                    class="d-flex gap-2 align-items-center text-capitalize mb-3 font-weight-bold text-capitalize">
                                    <img width="22"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                                        ...
                                        <label class="switcher">
                                            <input type="checkbox" name="download_google_app_status" value="1"
                                                ...
                                                {{isset($downloadWholesalerApp?->download_google_app_status) &&
                                            $downloadWholesalerApp?->download_google_app_status == 1 ? 'checked' : ''}}>
                                            <span class="switcher_control"></span>
                                        </label>
                                    </div>

                                    <input type="url" name="download_google_app" class="form-control"
                                        value="{{ $downloadWholesalerApp?->download_google_app}}"
                            ...
                            <div class="col-lg-6">
                                <div
                                    class="d-flex gap-2 align-items-center text-capitalize mb-3 font-weight-bold text-capitalize">
                                    <img width="22" src="{{dynamicAsset(path: 'public/assets/back-end/img/apple.png')}}"
                                        alt="">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-2 mb-2">
                                        ...
                                        <label class="switcher">
                                            <input type="checkbox" name="download_apple_app_status" value="1"
                                                class="switcher_input"
                                                {{isset($downloadWholesalerApp?->download_apple_app_status) &&
                                            $downloadWholesalerApp?->download_apple_app_status == 1 ? 'checked' : ''}}>
                                            <span class="switcher_control"></span>
                                        </label>
                                    </div>
                                    <input type="url" name="download_apple_app" class="form-control"
                                        value="{{ $downloadWholesalerApp?->download_apple_app }}"
