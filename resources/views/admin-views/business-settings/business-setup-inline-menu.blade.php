...
<div class="inline-page-menu my-4">
        <ul class="list-unstyled">
                ...
                <li class="{{ Request::is('admin/warranty-settings') ?'active':'' }}"><a
                ...
                <li class="text-capitalize {{ Request::is('admin/business-settings/state-city') ? 'active':'' }}"><a
                ...
                <li class="text-capitalize {{ Request::is('admin/business-settings/quotation-settings') ? 'active':'' }}"><a
