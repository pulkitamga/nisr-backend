...
<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('admin/business-settings/web-config/'.BusinessSettings::CACHE[URI]) ?'active':'' }}">
            <a href="{{route('admin.business-settings.web-config.cache-settings')}}">{{translate('Cache')}}</a>
        </li>
