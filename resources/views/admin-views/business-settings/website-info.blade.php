                                    ...
                                    <div class="tab-pane fade {{ $lang == $defaultLanguage ? 'show active' : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="form-group">
                                                    <label class="title-color d-flex">
                                                        {{translate('company_Name')}} ({{ strtoupper($lang) }})
                                                        @if($lang == $defaultLanguage)<span class="text-danger">*</span>@endif
                                                    </label>
                                                    <input class="form-control" type="text" name="company_name[]"
                                                           value="{{ $businessSetting['company_name_translations'][$lang] ?? '' }}"
                                            ...
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="form-group">
                                                    <label class="title-color d-flex">
                                                        {{translate('company_address')}} ({{ strtoupper($lang) }})
                                                        @if($lang == $defaultLanguage)<span class="text-danger">*</span>@endif
                                                    </label>
                                                    <input type="text"
                                                           value="{{ $businessSetting['shop_address_translations'][$lang] ?? '' }}"
                                                           name="shop_address[]" class="form-control"
                                                           id="{{ $lang == $defaultLanguage ? 'shop-address' : 'shop-address-'.$lang }}"
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <label class="title-color d-flex">{{translate('currency_space')}}</label>
                            <div class="form-control form-group d-flex gap-2">
                                <div class="custom-control custom-radio flex-grow-1">
                                    <input type="radio" class="custom-control-input" value="0"
                                           name="currency_symbol_space"
                                           id="currency_space_without" {{ ($businessSetting['currency_symbol_space'] ?? '0') == '0' ? 'checked':'' }}>
                                    <label class="custom-control-label"
                                           for="currency_space_without">{{translate('without_space')}}</label>
                                </div>
                                <div class="custom-control custom-radio flex-grow-1">
                                    <input type="radio" class="custom-control-input" value="1"
                                           name="currency_symbol_space"
                                           id="currency_space_with" {{ ($businessSetting['currency_symbol_space'] ?? '0') == '1' ? 'checked':'' }}>
                                    <label class="custom-control-label"
                                           for="currency_space_with">{{translate('with_space')}}</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="tab-pane fade {{ $lang == $defaultLanguage ? 'show active' : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="form-group">
                                                    <label class="title-color d-flex">
                                                        {{translate('Company_Copyright_Text')}} ({{ strtoupper($lang) }})
                                                        @if($lang == $defaultLanguage)<span class="text-danger">*</span>@endif
                                                    </label>
                                        ...
                                        <input type="hidden" name="text_lang[]" value="{{ $lang }}">
                                    </div>
                                @endforeach
                            </div>
                        </div>
