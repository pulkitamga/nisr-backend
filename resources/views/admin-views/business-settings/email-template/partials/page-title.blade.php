    ...
    <div>
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item {{$template['user_type']=='wholesaler' ? 'active' : ''}}" href="{{route('admin.business-settings.email-templates.view',['wholesaler',EmailTemplateKey::WHOLESALER_EMAIL_LIST[0]])}}">{{translate('wholesaler_mail_template')}}</a>
            </div>
        </div>
    </div>
</div>
