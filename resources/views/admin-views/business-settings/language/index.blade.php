                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-lowercase" id="language-code" name="code"
                                               placeholder="{{translate('language_code')}}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                        ...
                        <form action="{{route('admin.business-settings.language.update')}}" method="post">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="col-form-label">{{translate('language_code')}}</label>
