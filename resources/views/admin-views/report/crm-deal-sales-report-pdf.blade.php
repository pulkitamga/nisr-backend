...
<body>
    ...
    <table>
        ...
        <tbody>
        <tr><td class="left">{{ translate('won_sales') }}</td><td>{{ number_format((float)$summary['won_sales_total'], 2) }}</td></tr>
        <tr><td class="left">{{ translate('retail_won_sales') }}</td><td>{{ number_format((float)$summary['retail_won_sales'], 2) }}</td></tr>
        <tr><td class="left">{{ translate('wholesale_won_sales') }}</td><td>{{ number_format((float)$summary['wholesale_won_sales'], 2) }}</td></tr>
        <tr><td class="left">{{ translate('won_deals') }}</td><td>{{ (int)$summary['won_count'] }}</td></tr>
        <tr><td class="left">{{ translate('lost_deals') }}</td><td>{{ (int)$summary['lost_count'] }}</td></tr>
        <tr><td class="left">{{ translate('total_deals') }}</td><td>{{ (int)$summary['total_deals'] }}</td></tr>
        </tbody>
    </table>
