...
@section('content')
    ...
    @php($dateRange = \Carbon\Carbon::parse($filters['from'])->format('d M Y') . ' - ' . \Carbon\Carbon::parse($filters['to'])->format('d M Y'))
                    ...
                    <div class="row g-2 align-items-start">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control" name="date_range" id="date_range">
                                 <option value="this_year" {{ request('date_range') == 'this_year' ? 'selected' : '' }}>This Year
                                </option>
                    ...
                    <tbody>
                        ...
                        @forelse($departmentSections as $section)
                            <tr class="table-active">
                                <td colspan="10"><strong>{{ $section->department_name }}</strong></td>
                            </tr>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function toggleCustom() {
                ...
                document.querySelectorAll(".custom-date").forEach(el => {
                    el.classList.toggle("d-none", range !== "custom");
                });
            }

            toggleCustom();

            document.getElementById("date_range").addEventListener("change", toggleCustom);
