...
<head>
    ...
    <style>
        body {
            ...
            text-align: {
                    {
                    (session('direction')==='rtl' || app()->getLocale()==='ar') ? 'right': 'left'
                }
            }
        ...
        .report-header {
            /* mPDF is picky with gradients; using background-color as a fallback is safer */
            /* background-color: #0f766e; */
            /* mPDF specific gradient syntax often works better like this */
        ...
        .report-header {
            background-color: #0f766e;
            /* mPDF specific gradient property for that smooth green look */
        ...
        /* KPI Card Container - Fixed for mPDF */
        .kpi-container {
        ...
        /* Ensure no default table styles interfere with the header layout */
        .header-table td {
            padding: 0 !important;
