        ...
        <div class="modal-content">
            <form action="{{ route('admin.crm.add.message') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('Subject') }} <span class="input-required-icon">*</span></label>
                            <input type="text" class="form-control" name="subject" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('Sender Name') }} <span class="input-required-icon">*</span></label>
                            <input type="text" class="form-control" name="sender_name" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('Sender Email') }}</label>
                            <input type="email" class="form-control" name="sender_email">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('Sender Phone') }}</label>
                            <input type="text" class="form-control" name="sender_phone">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('Channel') }} <span class="input-required-icon">*</span></label>
