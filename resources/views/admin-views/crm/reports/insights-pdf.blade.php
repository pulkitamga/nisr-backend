...
<body>
    ...
    <p class="metric-line">{{ translate('messages') }}: <span class="value-ltr">{{ number_format((int)($kpi['message_count'] ?? 0)) }}</span></p>
    <p class="metric-line">{{ translate('deals') }}: <span class="value-ltr">{{ number_format((int)($kpi['deal_count'] ?? 0)) }}</span></p>
    <table>
        <thead>
        <tr>
