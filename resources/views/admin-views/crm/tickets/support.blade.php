...
<div class="content container-fluid">
    @php
        ...
        $statusId = request()->has('status') ? request()->input('status') : (string) \App\Support\SupportTicketLifecycle::STATUS_NEW;
        ...
        $toolbarFields = [
            [
                ...
                'aria_label' => translate('search_ticket_by_subject_customer_email_phone_priority_or_status'),
            ...
            [
                ...
                'value' => $priority,
                'options' => collect(['all', 'normal', 'low', 'medium', 'high', 'urgent', 'critical'])
        ...
        $headerActions = [
            [
                'type' => 'export',
                'url' => route('admin.support-ticket.export', 'support'),
                'form_id' => 'crm-support-ticket-toolbar',
            ...
            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.support-ticket.details', $ticket->id) }}" class="text-primary font-weight-semibold">
                            ...
                            <div class="crm-row-actions">
                                ...
                                <div class="dropdown crm-row-actions__menu">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#showSupportFollowUpModal"
            ...
            <div class="modal-body pt-0">
                <form id="updateSupportTicketFollowUpForm" action="{{ route('admin.complaints.update-support-follow-up') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="ticket-follow-up-status" id="support-follow-up-status" data-in-progress-id="{{ $supportInProgressStatusId }}">
                                    ...
                                    <option value="{{ $statusOption['id'] }}"
                                        ...
                                        {{ $statusOption->getTranslatedField('name') }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="row d-none" id="support-ticket-next-follow-up-date-row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label" for="support-ticket-next-follow-up-date">{{ translate('Next_Follow_Up_Date') }}</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="3" class="form-control" name="ticket-follow-up-note" id="support-follow-up-note" placeholder="{{ translate('enter_follow_up_note') }}"></textarea>
                            </div>
                        </div>
                    </div>
