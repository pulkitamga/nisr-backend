                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="badge badge-soft-primary">{{ $product->variation_type }}</span>
                                    ...
                                    <td class="">
                                        <div class="{{ $product->status == 'transferred' ? ' text-success' : 'text-danger' }} d-flex align-items-center gap-3 font-weight-bolder mb-2">
                                            ...
                                            <div class="ripple-animation"
                                                data-toggle="modal"
                                                data-target="#showBranchesStockModal"
                                                data-stock-product-id="{{ $product->product_id }}"
                                                data-stock-request-product-id="{{ $product->id }}"
                                                data-stock-request-id="{{ $product->stock_requests_id }}">
                                                <i class="tio-edit"></i>
                                            </div>
    ...
    <span id="download-error-route"
        data-url="{{ route('admin.stock-transfer.download-error-csv', ':filename') }}"></span>
    @endsection
