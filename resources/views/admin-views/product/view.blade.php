...
<div class="content container-fluid text-start">
    ...
    <div class="card card-top-bg-element">
        <div class="card-body">
            <div>
                <div
                    class="media flex-nowrap flex-column flex-sm-row gap-3 flex-grow-1 align-items-center align-items-md-start">
                    ...
                    <div class="d-block flex-grow-1 w-max-md-100">
                            ...
                            <ul class="nav nav-tabs w-fit-content mb-2">
                                ...
                                <li class="nav-item text-capitalize">
                                    <a class="nav-link lang-link {{$language == $activeLanguage ? 'active' : ''}}"
                                        href="javascript:" id="{{$language}}-link">{{
                        ...
                        <div
                            ...
                            <div class="d-flex flex-wrap gap-2 align-items-center">
                                ...
                                @if ($product->product_type == 'physical' && !empty($product->color_image) &&
                ...
                <div class="border p-3 mobile-w-100 w-170">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <h3 class="text-primary fs-18">
                            {{setCurrencySymbol(amount: usdToDefaultCurrency(amount: ($product['priceSum'] -
                            $product['discountSum']))) }}
                        </h3>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="pair-list">
                            ...
                            <div>
                                ...
                                <span>:</span>
                                <span class="value">
                                    {{isset($product->branches) ? $product->branches->branch_name :
                                    translate('branch_not_found') }}
                                </span>
                            </div>
                            <div>
...
<div>
    ...
    <span class="value">
        ...
        @endif
                    ...
                    <div class="col-sm-6 col-xl-3 g-2">

                        <div class="row g-1">
                            <h4 class="mb-3">{{ translate('make:') }}</h4>
                            <div class="pair-list">
                                <div>
                                    <span class="value">
                        ...
                        <div class="row g-1">
                            <h4 class="mb-3">{{ translate('model:') }}</h4>
                            <div class="pair-list">
                                <div>
                                    <span class="value">
                        ...
                        <div class="row g-1">
                            <h4 class="mb-3">{{ translate('year:') }}</h4>
                            <div class="pair-list">
                                <div>
                                    <span class="value">
                                        @if(!empty($product->match_years) && is_iterable($product->match_years))
                                        @foreach($product->match_years as $year)
                                        {{ $year . ',' }}
                                        @endforeach
                                        @else
                                        <em class="text-muted">{{ __('N/A') }}</em>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="py-1">{{setCurrencySymbol(amount: usdToDefaultCurrency(amount:
                                            $value->price), currencyCode: getCurrencyCode())}}</span>
                                    </td>
                                    <td class="text-center">
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="py-1">
                                            {{setCurrencySymbol(amount: usdToDefaultCurrency(amount: $variation->price),
                ...
                <div class="card-body">
                    <div>
                        <h6 class="mb-3 text-capitalize">
                            {{ $product?->seoInfo?->title ?? ( $product->meta_title ??
                            translate('meta_title_not_found').' '.'!')}}
                        </h6>
                    </div>
                    <p class="text-capitalize">
                        {{ $product?->seoInfo?->description ?? ($product->meta_description ??
                        translate('meta_description_not_found').' '.'!')}}
                    </p>
        ...
        <div class="col-md-6">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ (str_contains($product->video_url, " https://") || str_contains($product->video_url,
                        "http://")) ? $product['video_url'] : "javascript:"}}" target="_blank"
                        class="text-primary {{(str_contains($product->video_url, "https://") ||
                        str_contains($product->video_url, "http://"))?'' : 'cursor-default' }}">
                        {{$product['video_url']}}
                    </a>
                    @else
                            ...
                            <form action="{{ route('admin.reviews.status', [$review['id'], $review->status ? 0 : 1]) }}"
                                ...
                                <label class="switcher mx-auto">
                                    <input type="checkbox" class="switcher_input toggle-switch-message" name="status"
                                        id="reviews-status{{ $review['id'] }}" value="1" {{ $review['status']==1
                                        ? 'checked' : '' }} data-modal-id="toggle-status-modal"
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                <div data-toggle="modal" data-target="#review-update-for-{{ $review['id'] }}">
                                    ...
                                    <a class="btn btn-outline-primary btn-sm square-btn"
                                        title="{{ translate('Update_Review') }}" data-toggle="tooltip">
                                        <i class="tio-edit"></i>
                                    </a>
                                    @else
                                    <div class="btn btn-outline--primary btn-sm square-btn"
                                        title="{{ translate('Review_Reply') }}" data-toggle="tooltip">
                                ...
                                <div>
                                    <a class="btn btn-outline-primary btn-sm square-btn"
                                        title="{{ translate('product_not_found') }}" data-toggle="tooltip">
                                        @if($review?->reply)
                                        <i class="tio-edit"></i>
                                        @else
                                        <i class="tio-reply-all"></i>
                ...
                <div class="modal-content text-start">
                    ...
                    <div class="modal-body pt-0">
                        ...
                        <div class="d-flex align-items-center gap-1 text-primary justify-content-center fz-14 mb-4">
                            @for($i = 1; $i <= 5; $i++) @if($i <=$review['rating']) <i class="tio-star"></i>
                                @else
...
<div class="modal fade" id="publishNoteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content text-start">
            ...
            <form class="form-group" action="{{ route('admin.products.deny', ['id'=>$product['id']]) }}" method="post"
                id="product-status-denied">
                @csrf
