                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3" id="digital_product_type_show">
                        <div class="form-group">
                            ...
                            <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="{{
                        ...
                        <div class="form-group">
                            <label class="title-color d-flex justify-content-between gap-2">
                                <span class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="input-required-icon">*</span>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="{{ translate('create_a_unique_product_code_by_clicking_on_the_Generate_Code_button') }}">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}" alt="">
                                    </span>
                                </span>
...
{{-- 
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="js-select2-custom form-control" name="match_years[]" multiple>
                            ...
                            <div class="form-control h-auto min-form-control-height d-flex align-items-center flex-wrap justify-content-between gap-2.5">
                                ...
                                <label class="switcher">
                                    <input type="checkbox"
                                        class="switcher_input"
                                        name="is_warranty"
                                        value="1" {{ old('is_warranty') ? 'checked' : '' }}>
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
        ...
        <div class="card mt-3 service_product_show" id="service_section">
            <div class="card-header">
                <div class="d-flex gap-2">
            ...
            <div class="card-body">
                ...
                <div class="language-tab-form {{ $lang != $activeLanguage ? 'd-none' : '' }}" data-lang="{{ $lang }}">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <label class="title-color">
                                {{ translate('parts_included') }} ({{ strtoupper($lang) }}) <span class="input-required-icon">*</span>
                            </label>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="form-group">
                            <label class="title-color">{{ translate('service_id') }} <span class="input-required-icon">*</span></label>
                            <input type="text" name="service_id" class="form-control" placeholder="{{ translate('e.g. SRV-OIL-SYN') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="form-group">
                            <label class="title-color">{{ translate('base_price_mobile') }} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}) <span class="input-required-icon">*</span></label>
                            <input type="number" name="base_price_mobile" class="form-control" min="0" step="0.01" placeholder="{{ translate('e.g. 27.5') }}">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="form-group">
                            <label class="title-color">{{ translate('parts_cost') }} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}) <span class="input-required-icon">*</span></label>
                            <input type="number" name="parts_cost" class="form-control" min="0" step="0.01" placeholder="{{ translate('e.g. 0') }}">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="form-group">
                            <label class="title-color">{{ translate('included_km_mobile') }} <span class="input-required-icon">*</span></label>
                            <input type="number" name="included_km_mobile" class="form-control" min="0" step="1" placeholder="{{ translate('e.g. 20') }}">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="form-group">
                            <label class="title-color">{{ translate('travel_fee_per_km') }} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}) <span class="input-required-icon">*</span></label>
                            <input type="number" name="travel_fee_per_km" class="form-control" min="0" step="0.01" placeholder="{{ translate('e.g. 1') }}">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group">
                            <label class="title-color">{{ translate('labor_hours') }} <span class="input-required-icon">*</span></label>
                            <input type="number" name="labor_hours" class="form-control" min="0" step="0.1" placeholder="{{ translate('e.g. 0.5') }}">
                        </div>
                    </div>
        ...
        <div class="card mt-3 rest-part">
            ...
            <div class="card-body">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3" id="unit_price_wrapper">
                        <div class="form-group">
                            <div class="d-flex gap-2 mb-2">
                                <label class="title-color mb-0">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="{{ translate('set_the_selling_price_for_each_unit_of_this_product._This_Unit_Price_section_would_not_be_applied_if_you_set_a_variation_wise_price') }}.">
                                    <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}" alt="">
                                </span>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3" id="minimum_order_qty">
                        <div class="form-group">
                            <div class="d-flex gap-2 mb-2">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="{{ translate('set_the_minimum_order_quantity_that_customers_must_choose._Otherwise,_the_checkout_process_would_not_start') }}.">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <div class="d-flex gap-2">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="{{ translate('set_the_tax_calculation_method_from_here.').' '.translate('select_Include_with_product_to_combine_product_price_and_tax_on_the_checkout.').' '.translate('pick_Exclude_from_product_to_display_product_price_and_tax_amount_separately.') }}">
                                    <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}" alt="">
                                </span>
                            </div>
                            <input type="hidden" name="tax_model" value="{{ $configuredTaxModel }}">
                            <select id="tax_model" class="form-control" disabled>
                                <option value="{{ $configuredTaxModel }}" selected>
                                    {{ translate($configuredTaxModel === 'include' ? 'include_with_product' : 'exclude_with_product') }}
                                </option>
                            </select>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="custom_upload_input position-relative border-dashed-2">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                            <img id="additional_Image_1" class="h-auto aspect-1 bg-white d-none " src="{{ dynamicAsset(path: 'public/assets/back-end/img/icons/product-upload-icon.svg') }}" alt="">
                                        </div>
                                        <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-1">
                                    <div>
                                        ...
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" title="{{ translate('upload_a_suitable_file_for_a_short_product_preview.') }} {{ translate('this_preview_will_be_common_for_all_variations.') }}">
                                            <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}" alt="">
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="d-flex justify-content-center">
                            <div class="form-group w-100">
                                ...
                                <div>
                                    <div class="custom_upload_input">
                                        <input type="file" name="meta_image" class="custom-upload-input-file meta-img action-upload-color-image" data-imgpreview="pre_meta_image_viewer" id="meta_image_input" accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        ...
                                        <div class="img_area_with_preview position-absolute z-index-2 d-flex align-items-center justify-content-center">
                                            <img id="pre_meta_image_viewer" class="h-auto bg-white onerror-add-class-d-none pre-meta-image-viewer" alt="" src="{{ dynamicAsset(path: 'public/assets/back-end/img/icons/product-upload-icon.svg-dummy') }}">
                                        </div>
...
<script>
    ...
    // Make/Model dropdown functionality
    $(document).ready(function() {
        console.log('Document ready - initializing make/model functionality');
        
        // Update models when makes change
        $('select[name="match_makes[]"]').on('change', function() {
            console.log('Make selection changed');
            updateModelDropdown();
        });
        
        // Initialize models based on selected makes
        updateModelDropdown();
        
        function updateModelDropdown() {
            var selectedMakes = $('select[name="match_makes[]"]').val();
            console.log('Selected makes:', selectedMakes);
           
            if (!selectedMakes || selectedMakes.length === 0) {
                console.log('No makes selected, clearing models');
                // Clear models if no makes selected
                $('select[name="match_models[]"]').html('').trigger('change');
                return;
            }
     
            $.ajax({
                url: '{{ route("admin.products.get-models-by-makes") }}',
                method: 'GET',
                data: {
                    makes: selectedMakes
                },
                success: function(response) {
                    ...
                    var modelsSelect = $('select[name="match_models[]"]');
                    var currentModels = modelsSelect.val() || [];
                    ...
                    if (response.models && Array.isArray(response.models)) {
                        ...
                        console.log('No models in response or invalid format');
                    }
