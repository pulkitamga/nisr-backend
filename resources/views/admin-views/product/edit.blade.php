...
@push('css_or_js')
    ...
    <style>
        ...
        .readonly-section .allow-edit-in-readonly {
            pointer-events: auto !important;
            background-color: #fff !important;
        }

        .readonly-section-type * {
            pointer-events: none !important;
        }
    </style>
@endpush
...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <form class="product-form text-start"
                    ...
                    @foreach ($languages as $language)
                        ...
                        if (count($product['translations'])) {
                            ...
                            foreach ($product['translations'] as $translation) {
                                ...
                                if ($translation->locale == $language && $translation->key == 'service_tittle') {
                                    $translate[$language]['service_tittle'] = $translation->value;
                                }
                            }
                        }
                        ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{ translate('Make') }}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('Add vehicle makes (e.g., BMW, Audi, etc.)') }}">
                                        <img width="16"
                                            src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{ translate('Model') }}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('Add vehicle models (e.g., Civic, Phantom, etc.)') }}">
                                        <img width="16"
                                            src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{ translate('Year') }}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        title="{{ translate('Add vehicle years (e.g., 2023, 2024, etc.)') }}">
                                        <img width="16"
                                            src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </label>
                                <select name="match_years[]" class="form-control js-select2-custom" multiple>
                                    @foreach ($years as $year)
                                        <option value="{{ $year->year }}"
                                            {{ in_array($year->year, $product->match_years ?? []) ? 'selected' : '' }}>
                                            {{ $year->year }}
                                        </option>
                                    @endforeach
                                </select>
            ...
            <div class="card mt-3 service_product_show">
                <div class="card-header">
                    <div class="d-flex gap-2">
                ...
                <div class="card-body">
                    ...
                    @foreach ($languages as $language)
                        ...
                        if (count($product['translations'])) {
                            foreach ($product['translations'] as $translation) {
                                ...
                                if ($translation->locale == $language && $translation->key == 'parts_included') {
                                    $translate[$language]['parts_included'] = $translation->value;
                                }
                            }
                        }
                        ?>
                        <div class="language-tab-form {{ $language != $defaultLanguage ? 'd-none' : '' }}"
                            ...
                            <div class="row">
                                ...
                                {{ $translate[$language]['service_tittle'] ?? ($product->service->title ?? '') }}
                            </textarea>
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        <label class="title-color">
                                            {{ translate('parts_included') }} ({{ strtoupper($language) }}) <span
                                                class="input-required-icon">*</span>
                                        </label>
                                        <textarea name="parts_included[]" class="form-control" rows="2"
                                            placeholder="{{ translate('e.g. 5 L 5W-30, OEM oil filter') }}">{{ $translate[$language]['parts_included'] ?? (implode(', ', $includedParts) ?? '') }}</textarea>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color">{{ translate('service_id') }} <span
                                        class="input-required-icon">*</span></label>
                                <input type="text" value="{{ optional($product->service)->service_id ?? '' }}"
                                    name="service_id" class="form-control"
                                    placeholder="{{ translate('e.g. SRV-OIL-SYN') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ optional($product->service)->base_price_inshop ?? '' }}"
                                    name="base_price_inshop" class="form-control" min="0" step="0.01"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color">{{ translate('base_price_mobile') }}
                                    ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}) <span
                                        class="input-required-icon">*</span></label>
                                <input type="number" value="{{ optional($product->service)->base_price_mobile ?? '' }}"
                                    name="base_price_mobile" class="form-control" min="0" step="0.01"
                                    placeholder="{{ translate('e.g. 27.5') }}">
                            </div>
                        </div>

                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color">{{ translate('parts_cost') }}
                                    ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}) <span
                                        class="input-required-icon">*</span></label>
                                <input type="number" value="{{ optional($product->service)->parts_cost ?? '' }}"
                                    name="parts_cost" class="form-control" min="0" step="0.01"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color">{{ translate('included_km_mobile') }} <span
                                        class="input-required-icon">*</span></label>
                                <input type="number"
                                    value="{{ optional($product->service)->included_km_mobile ?? '' }}"
                                    name="included_km_mobile" class="form-control" min="0" step="1"
                                    placeholder="{{ translate('e.g. 20') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color">{{ translate('travel_fee_per_km') }}
                                    ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}) <span
                                        class="input-required-icon">*</span></label>
                                <input type="number" value="{{ optional($product->service)->travel_fee_per_km ?? '' }}"
                                    name="travel_fee_per_km" class="form-control" min="0" step="0.01"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color">{{ translate('labor_hours') }} <span
                                        class="input-required-icon">*</span></label>
                                <input type="number" value="{{ optional($product->service)->labor_hours ?? '' }}"
                                    name="labor_hours" class="form-control" min="0" step="0.1"
                                    placeholder="{{ translate('e.g. 0.5') }}">
                            </div>
                        </div>
                                ...
                                <div
                                    ...
                                    <label class="switcher">
                                        <input type="checkbox" class="switcher_input" name="call_center_flag"
                                            value="1"
                                            {{ optional($product->service)->call_center_flag == 1 ? 'checked' : '' }}>
                                        <span class="switcher_control"></span>
                                    </label>
                                </div>
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="minimum_order_qty">
                            <div class="form-group">
                                <div class="d-flex gap-2">
            ...
            <div class="card mt-3 rest-part physical_product_show">
                ...
                <div class="card-body readonly-section">
                    <div class="row align-items-end">
                        <div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    @foreach ($attributes as $key => $attribute)
                                        @if ($product['attributes'] != 'null')
                                            <option value="{{ $attribute['id'] }}"
                                                {{ in_array($attribute->id, $selectedAttributeIds) ? 'selected' : '' }}>
                                                {{ $attribute['name'] }}
                                            </option>
                                        @else
                        ...
                        <div class="col-md-12 mt-2 mb-2">
                            ...
                            <div class="sku_combination table-responsive form-group mt-2" id="sku_combination">
                                @include('admin-views.product.partials._edit-product-variation-pricing-sku', [
...
@push('script')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tabs.forEach(tab => {
                tab.addEventListener('click', function() {
                    ...
                    document.querySelector(`.language-tab-form[data-lang="${lang}"]`)?.classList
                        .remove('d-none');
                });
            });
        });
    ...
    <script>
        ...
        $(document).ready(function() {
            // Initialize models based on selected makes on page load
            updateModelDropdown();
            ...
            function updateModelDropdown() {
                ...
                var selectedModels = $('select[name="match_models[]"]').val();
