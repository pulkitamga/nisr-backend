...
@section('title', translate('product_page_sections'))

@push('css_or_js')
    <link href="{{ dynamicAsset(path: 'public/assets/back-end/plugins/summernote/summernote.min.css') }}" rel="stylesheet">
    <style>
        body.cms-admin-theme #content .products-cms-page .cms-admin-heading {
            align-items: flex-start;
        }

        body.cms-admin-theme #content .products-cms-page .cms-admin-heading__note {
            margin: .35rem 0 0;
            max-width: 68ch;
            color: #60748a;
            line-height: 1.7;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-admin-shell {
            direction: inherit;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-grid-2 {
            display: grid;
            grid-template-columns: repeat(auto-fit, minmax(24rem, 1fr));
            gap: 1.25rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-panel {
            border-radius: 1.25rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-panel__header {
            display: flex;
            align-items: flex-start;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-panel__header > div:first-child {
            min-width: 0;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-panel__title {
            margin: 0;
            color: #1e3250;
            font-size: 1.06rem;
            font-weight: 700;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-panel__note {
            margin: .35rem 0 0;
            color: #60748a;
            line-height: 1.65;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-panel__body {
            display: grid;
            gap: 1rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-card {
            display: grid;
            gap: 1rem;
            padding: 1rem;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-card__title {
            margin: 0;
            color: #1e3250;
            font-size: 1rem;
            font-weight: 700;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-card__note {
            margin: .25rem 0 0;
            color: #60748a;
            line-height: 1.6;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-panel__body > form,
        body.cms-admin-theme #content .products-cms-page .catalogue-card > form,
        body.cms-admin-theme #content .products-cms-page .catalogue-support-form__content,
        body.cms-admin-theme #content .products-cms-page .catalogue-support-form__media {
            display: grid;
            gap: 1rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-locale-tabs {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
            gap: .75rem;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-locale-tab {
            display: inline-flex;
            flex: 0 0 auto;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-locale-tab:hover {
            color: #1455ac;
            border-color: #1455ac;
            text-decoration: none;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-locale-tab.active {
            color: #1455ac;
            border-color: #1455ac;
            background: #fff;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-image-preview {
            position: relative;
            display: flex;
            width: 100%;
            max-width: 20rem;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-image-preview--wide {
            max-width: 27rem;
            aspect-ratio: 16 / 9;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-image-preview img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            border: 0;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-image-remove {
            position: absolute;
            top: .65rem;
            inset-inline-end: .65rem;
            width: 2rem;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-status-chip,
        body.cms-admin-theme #content .products-cms-page .catalogue-type-chip {
            display: inline-flex;
            align-items: center;
            min-height: 2rem;
            padding: .35rem .72rem;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-status-chip--muted {
            background: #eef3f7;
            color: #60748a;
        }
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-list,
        body.cms-admin-theme #content .products-cms-page .catalogue-support-stack {
            display: grid;
            gap: 1rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-item {
            display: grid;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-item > div:first-child {
            width: 100%;
            max-width: 18rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-item > div:last-child {
            display: grid;
            gap: .75rem;
            align-content: start;
            min-width: 0;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-item__media,
        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-item__empty {
            display: block;
            width: 100%;
            aspect-ratio: 16 / 9;
            min-height: 12rem;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-item__title {
            margin: 0;
            color: #1e3250;
            font-size: 1.12rem;
            line-height: 1.3;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-showcase-item__copy {
            margin: 0;
            color: #60748a;
            line-height: 1.7;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-actions {
            display: flex;
            flex-wrap: wrap;
            gap: .65rem;
            align-items: center;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-actions .btn {
            min-height: 2.7rem;
            padding-inline: 1rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-actions form {
            margin: 0;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-empty {
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-support-form {
            display: grid;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-support-form__head {
            grid-column: 1 / -1;
            display: flex;
            flex-wrap: wrap;
            align-items: start;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-support-form__preview img {
            height: 100%;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-toggle-wrap {
            display: inline-flex;
            align-items: center;
            gap: .7rem;
        ...
        body.cms-admin-theme #content .products-cms-page .catalogue-switch-label {
            margin-inline-start: .45rem;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-panel__tools {
            margin-inline-start: auto;
            flex-shrink: 0;
        }

        body.cms-admin-theme #content .products-cms-page .catalogue-meta-row,
        body.cms-admin-theme #content .products-cms-page .catalogue-switch-field {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
            gap: .65rem;
        ...
        body.cms-admin-theme #content .products-cms-page .note-editor.note-frame {
            border-color: #d7e3ef;
            border-radius: 1rem;
            overflow: hidden;
            background: #fff;
        ...
        body.cms-admin-theme #content .products-cms-page .note-editor .note-toolbar {
            background: #f7fbff;
        }
        ...
        body.cms-admin-theme #content .catalogue-modal__close:not(:disabled):not(.disabled):hover {
            color: #1455ac;
            background: #eef5fb;
            opacity: 1;
        }

        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-panel__header,
        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-card,
        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-showcase-item,
        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-support-form,
        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-support-form__content,
        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-support-form__media,
        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-meta-row,
        body.cms-admin-theme #content .products-cms-page[dir="rtl"] .catalogue-switch-field,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .modal-body,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .modal-footer,
        ...
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .modal-header,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .modal-footer,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .catalogue-actions,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .catalogue-locale-tabs,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .catalogue-meta-row,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .catalogue-switch-field,
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .catalogue-support-form__head {
            flex-direction: row;
        }

        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .catalogue-modal__head {
            text-align: right;
        }
        ...
        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .modal-footer .btn--primary {
            order: -1;
        }

        body.cms-admin-theme #content .catalogue-modal[dir="rtl"] .catalogue-image-preview {
...
@section('content')
    <div class="content container-fluid products-cms-page" dir="{{ $direction }}">
        <div class="catalogue-admin-shell">
            <div class="cms-admin-heading">
                <div>
                    <h1 class="cms-admin-heading__title h3">{{ translate('product_page_sections') }}</h1>
                    <p class="cms-admin-heading__note mb-0">{{ translate('Manage_the_products_page_header_hero_showcase_slider_and_support_cards_from_one_screen') }}</p>
                </div>
            </div>
                    ...
                    <section class="card catalogue-panel">
                        <div class="card-header catalogue-panel__header">
                            <div>
                                ...
                                <p class="catalogue-panel__note">{{ translate('Controls_the_page_header_content_shown_at_the_top_of_the_products_page') }}</p>
                            </div>
                        ...
                        <div class="card-body catalogue-panel__body">
                            <form action="{{ route('admin.content-management.products.update', ['id' => $headerSection->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                    ...
                    <section class="card catalogue-panel">
                        <div class="card-header catalogue-panel__header">
                            <div>
                                ...
                                <p class="catalogue-panel__note">{{ translate('Controls_the_main_hero_copy_and_base_slide_for_the_products_page') }}</p>
                            </div>
                            <div class="catalogue-toggle-wrap">
                        ...
                        <div class="card-body catalogue-panel__body">
                            <form action="{{ route('admin.content-management.products.update', ['id' => $heroSection->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                            ...
                            <div class="catalogue-card mt-4">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
                                    <div>
                                        ...
                                        <p class="catalogue-card__note">{{ translate('Manage_the_additional_hero_slides_that_rotate_in_the_products_page_banner') }}</p>
                                    </div>
                                            ...
                                            <article class="catalogue-showcase-item">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="catalogue-actions">
                                                        ...
                                                        <form action="{{ route('admin.content-management.products.showcase-items.destroy', ['id' => $item->id]) }}" method="POST" onsubmit="return confirm('{{ translate('Are_you_sure_delete_this') }}')">
                                                            @csrf
                                                            @method('DELETE')
                ...
                <section class="card catalogue-panel">
                    ...
                    <div class="card-body catalogue-panel__body">
                        <div class="catalogue-card mb-4">
                            ...
                            <form action="{{ route('admin.content-management.products.update', ['id' => $showcaseSection->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                    ...
                    <div class="card-body catalogue-panel__body">
                        <div class="catalogue-support-stack">
                            @foreach($supportSections as $section)
                                ...
                                @endphp
                                <form class="catalogue-card catalogue-support-form" action="{{ route('admin.content-management.products.update', ['id' => $section->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="catalogue-support-form__head">
                                        <div>
                                            ...
                                            <p class="catalogue-card__note">{{ translate('Controls_one_of_the_support_story_cards_on_the_products_page') }}</p>
                                        </div>
                                        <div class="catalogue-toggle-wrap">
                                            <label class="switcher mb-0">
        ...
        <div class="modal fade catalogue-modal" id="createHeroSlideModal" tabindex="-1" aria-hidden="true" dir="{{ $direction }}">
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.content-management.products.showcase-items.store', ['id' => $heroSection->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row g-4 catalogue-modal__layout">
                                ...
                                <div class="col-lg-7">
                                    <div class="catalogue-card h-100">
                                        ...
                                        <p class="catalogue-card__note">{{ translate('This_content_appears_inside_the_products_page_hero_slide') }}</p>
            ...
            <div class="modal fade catalogue-modal" id="editHeroSlideModal{{ $item->id }}" tabindex="-1" aria-hidden="true" dir="{{ $direction }}">
                <div class="modal-dialog modal-xl modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.content-management.products.showcase-items.update', ['id' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="modal-body">
                                <div class="row g-4 catalogue-modal__layout">
        ...
        <div class="modal fade catalogue-modal" id="createShowcaseCardModal" tabindex="-1" aria-hidden="true" dir="{{ $direction }}">
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.content-management.products.showcase-items.store', ['id' => $showcaseSection->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="row g-4 catalogue-modal__layout">
                                <div class="col-lg-5">
