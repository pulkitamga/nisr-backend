...
@section('title', translate('Edit Benefits'))
@push('css_or_js')
<!-- Summernote CSS -->
...
<div class="content container-fluid">
    <h2 class="h1 mb-4">{{ translate('Edit Perk') }}</h2>

    <form action="{{ route('admin.content-management.career.update', ['section' => 'perks', 'id' => $job->id]) }}"
