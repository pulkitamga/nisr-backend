...
<form action="{{route('admin.pos.place-order') }}" method="post" id='order-place'>
    ...
    <input type="hidden" name="amount" value="{{ usdToDefaultCurrency(amount: $total) }}" readonly>
    ...
    <div id="cart">
        <div class="table-responsive pos-cart-table border">
            <table class="table table-align-middle m-0">
                ...
                <tbody>
                    ...
                    <input type="hidden" name="items[{{ $key }}][installation_charge]" value="{{ $item['installation_charge'] ?? 0 }}">
                    <input type="hidden" name="items[{{ $key }}][exchange_charge]" value="{{ $item['exchange_charge'] ?? 0 }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount:$item['productSubtotal']),
        ...
        <div class="pt-4">
            <dl>
                ...
                @if($installationTotel > 0)
                <div class="d-flex gap-2 justify-content-between">
                    <dt class="title-color text-capitalize font-weight-normal">{{ translate('Installation_Total') }} :
                    </dt>
                    <dd>{{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: round($installationTotel, 2)),
                        currencyCode: getCurrencyCode()) }}</dd>
                </div>
                @endif
            ...
            <div class="form-group col-12">
                <input type="hidden" class="form-control total-amount" name="amount" min="0" step="0.01"
                    value="{{ usdToDefaultCurrency(amount: $total) }}" readonly>
            </div>
            ...
            <div class="p-4 bg-chat rounded mt-4">
                <div>
                    ...
                    <ul class="list-unstyled option-buttons">
                        ...
                        <li>
                            ...
                            <label for="card" class="btn btn--bordered btn--bordered-black px-4 mb-0">{{
                ...
                <div class="cash-change-amount cash-change-section">
                    ...
                    <div class="d-flex gap-2 justify-content-between align-items-center">
                        ...
                        <dd class="font-weight-bold title-color pos-change-amount-element">{{ setCurrencySymbol(amount:
                            0) }}</dd>
                    </div>
                </div>
                ...
                <div class="cash-change-wallet cash-change-section d-none">
                    <div class="d-flex gap-2 justify-content-between align-items-center pt-4">
                        <dt class="text-capitalize font-weight-normal">{{ translate('Paid_Amount') }} : <span
