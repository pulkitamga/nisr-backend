            ...
            <div class="left-content-card">
                ...
                <div class="coupon__discount w-100 text-end d-flex justify-content-between">
                    <div class="text-center">
                        ...
                        <div class="d-flex">
                            <span>{{translate('in-House_Products')}}</span>
                        </div>
                    </div>
                    <!-- <div class="text-center">
        ...
        <div class="px-3 py-4">
            <div class="d-flex flex-wrap gap-3 align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <a type="button" href="{{ route('admin.transaction.order-transaction-export-excel', ['search'=>$search,'date_type'=>request('date_type'), 'seller_id'=>request('seller_id'), 'customer_id'=>request('customer_id'), 'status'=>request('status'), 'from'=>request('from'), 'to'=>request('to')]) }}"
