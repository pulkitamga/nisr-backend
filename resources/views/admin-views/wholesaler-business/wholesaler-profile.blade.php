        ...
        <div class="col-xl-6 col-xxl-6 col--xxl-6">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div>
                        <ul class="customer-details-new-card-content-list">
                            <li><strong class="key">{{ translate('Company') }}</strong><span class="mr-3">:</span><span class="value">{{
    ...
    <div class="col-lg-12 pt-lg-6">
        <div class="inline-page-menu my-4">
            <ul class="list-unstyled" id="orderTabs">
                <li class="">
                    <a class="nav-link active" href="#" data-type="purchase">{{ translate('Purchase Order') }}</a>
                </li>
                <li class="">
