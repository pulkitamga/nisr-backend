...
<span id="earn-statistics-data" data-inhouse-text = "{{translate('in_House')}}" data-vendor-text = "{{translate('Vendor')}}" data-commission-text = "{{translate('commission')}}" data-inhouse-earn="{{json_encode($inHouseEarning)}}" data-vendor-earn="{{json_encode($vendorEarning)}}" data-commission-earn ={{json_encode($commissionEarn)}} data-label="{{json_encode($label)}}"></span>
