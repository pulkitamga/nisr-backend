        ...
        <div class="col-xl-6 col-xxl-6 col--xxl-6">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div>
                        <ul class="customer-details-new-card-content-list">
                            <li><strong class="key">{{ __("Company") }}</strong><span class="field-colon">:</span><span class="value bidi-auto">{{
                                    $business->company_name }}</span></li>
                            <li><strong class="key">{{ __("Trade Name") }}</strong><span class="field-colon">:</span><span class="value bidi-auto">{{
                                    $business->trade_name }}</span></li>
                            <li><strong class="key">{{ __("Reg. No.") }}</strong><span class="field-colon">:</span><span class="value bidi-ltr">{{
                                    $business->registration_number }}</span></li>
                            <li><strong class="key">{{ __("Tax ID") }}</strong><span class="field-colon">:</span><span class="value bidi-ltr">{{
                                    $business->tax_id }}</span></li>
                            <li><strong class="key">{{ __("VAT No") }}</strong><span class="field-colon">:</span><span class="value bidi-ltr">{{
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <form method="POST"
                                ...
                                <button type="submit" class="btn btn-sm btn-outline-danger"
                                    onclick="return confirm('{{ __('Are you sure to delete?') }}')"> <i class="tio-delete"></i>
                                </button>
                            </form>
                        </div>
                        <div class="row card-body g-3">
                            <div class="col-md-6">
                                ...
                                <p class="mb-2"><strong>{{ __("Name") }}:</strong> <span class="bidi-auto">{{ $contact->first_name }} {{ $contact->last_name }}</span></p>
                                @if($contact->job_title)
                                <p class="mb-2"><strong>{{ __("Job Title") }}:</strong> <span class="bidi-auto">{{ $contact->job_title }}</span></p>
                                @endif
                                <p class="mb-2"><strong>{{ __("Email") }}:</strong> <span class="bidi-ltr">{{ $contact->email }}</span></p>
                                <p class="mb-2"><strong>{{ __("Phone") }}:</strong> <span class="bidi-ltr">{{ $contact->phone_number }}</span></p>
                                <p class="mb-2"><strong>{{ __("Mobile 1") }}:</strong> <span class="bidi-ltr">{{ $contact->mobile_number_1 }}</span></p>
                                <p class="mb-2"><strong>{{ __("Mobile 2") }}:</strong> <span class="bidi-ltr">{{ $contact->mobile_number_2 }}</span></p>
                                <p class="mb-2"><strong>{{ __("Preferred Contact Method") }}:</strong> <span class="bidi-auto">{{
                                    $contact->preferred_contact_method }}</span></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-2"><strong>{{ __("Address") }}:</strong><br>
                                ...
                                <p class="mb-2"><strong>{{ __("Notes") }}:</strong> <span class="bidi-auto">{{ $contact->notes }}</span></p>
                                <p class="mb-2"><strong>{{ __("Tags") }}:</strong> <span class="bidi-auto">{{ $contact->tags }}</span></p>
                                <p class="mb-2"><strong>{{ __("Active") }}:</strong> <span class="bidi-auto">{{ $contact->is_active ? __('Yes') : __('No') }}</span></p>
                                <p class="mb-2"><strong>{{ __("Last Contacted") }}:</strong> <span class="bidi-ltr">{{ $contact->last_contacted_at }}</span></p>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="{{ translate('Close') }}">X</button>
                                                ...
                                                <div class="modal-body row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label>{{ __("Last Contacted At") }}</label>
                        ...
                        <form action="{{ route('admin.wholesale.business.wholsaler-contect') }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="mobile_number_1" class="form-label">{{ __("Mobile Number 1") }}</label>
                                        <input type="text" name="mobile_number_1" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="mobile_number_2" class="form-label">{{ __("Mobile Number 2") }}</label>
                                        <input type="text" name="mobile_number_2" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label" for="is_active">{{ __('Yes') }}</label>
                                        </div>
                                    </div>
    ...
    <div class="col-lg-12 pt-lg-6">
        <div class="inline-page-menu my-4">
            <ul class="list-unstyled" id="orderTabs">
                ...
                <li class="">
                    <a class="nav-link" href="#" data-type="confirmed">{{ __("Confirmed Order") }}</a>
                </li>
            </ul>
        </div>
