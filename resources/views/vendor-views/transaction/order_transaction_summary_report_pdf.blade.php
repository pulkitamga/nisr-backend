                ...
                <tr>
                    <td class="p-0 text-start">
                        <table>
                            ...
                            <tr>
                                <th class="bold black p-0 text-start  p-3">{{translate('vendor_Info')}}</th>
                                <td class="p-0 p-3">:
                                    {{ $seller_info }}
                                </td>
                            </tr>
                    ...
                    <td class="p-0 text-start">
                        <table>
                            <tr>
                                <th class="bold black p-0 text-start">{{translate('total_Order')}} </th>
                                <td class="p-0 p-3">:
                                    {{ $data['total_orders'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-start">{{translate('completed_Orders')}}</th>
                                <td class="p-0 p-3">:
                                    {{ $data['completed_order'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-start">{{translate('ongoing_Orders')}}</th>
                                <td class="p-0 p-3">:
                                    {{ $data['ongoing_order'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-start">{{translate('canceled_Orders')}}</th>
                                <td class="p-0 p-3">:
                                    {{ $data['canceled_order'] }}
                                </td>
                            </tr>
...
<table class="content-position">
    <tr>
        <th class="text-start black bold"><b>{{translate('additional')}} {{translate('information')}}</b></th>
        <th class="text-end black bold"><b>{{translate('totals')}}</b></th>
    </tr>
