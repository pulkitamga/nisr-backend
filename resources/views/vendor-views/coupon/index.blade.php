                    ...
                    <div class="card-body">
                        <form action="{{route('vendor.coupon.add')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    <label for="name"
                                           class="title-color font-weight-medium d-flex">{{translate('minimum_purchase')}} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>
                                ...
                                <div class="col-md-6 col-lg-4 form-group free_delivery" id="max-discount">
                                    <label for="name"
                                           class="title-color font-weight-medium d-flex">{{translate('maximum_discount')}} ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }})</label>
