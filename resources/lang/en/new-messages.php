...
Request Service" => "Unlike many other WordPress website builder plugins  Elementor offers all the necessary tools and design features for free. Request Service",
	...
	"The layout is responsive and looks gorgeous and professional on any major devices and this theme comes with custom page templates, demo content, documentation

Request Service" => "The layout is responsive and looks gorgeous and professional on any major devices and this theme comes with custom page templates  demo content  documentation Request Service",
	"request_card_1" => "Request card 1",
	"request_card_2" => "Request card 2",
	"request_card_3" => "Request card 3",
	"Precision Tyre Fitting & Wheel Alignment
...
Request ServiceFlat tyre or dead battery? We’re just a call away. Our on-the-go experts provide round-the-clock assistance so you’re never stuck on the road for long." => "The layout is responsive and looks gorgeous and professional on any major devices and this theme comes with custom page templates  demo content  documentation Request ServiceFlat tyre or dead battery  We’re just a call away. Our on-the-go experts provide round-the-clock assistance so you’re never stuck on the road for long.",
	...
	"Add
            Charge" => "Add Charge",
	"Cheque" => "Cheque",
	"Confirem Order NO" => "Confirem Order NO",
	"new_stock" => "New stock",
	...
	"Wholesaler Moq Owerride" => "Wholesaler Moq Owerride",
	...
	"Confirme Order View" => "Confirme Order View",
	"Confirem Order Delivery" => "Confirem Order Delivery",
	"Confirem Order Payment" => "Confirem Order Payment",
	"Confirem Order Invoice" => "Confirem Order Invoice",
