...
return [
	...
	"Create_an_account_with_the_below_info" => "Create an account with the below info",
	...
	"unit_option_kg" => "kg",
	"unit_option_gms" => "gms",
	"unit_option_ltrs" => "ltrs",
	"unit_option_pair" => "pair",
	"unit_option_oz" => "oz",
	"unit_option_lb" => "lb",
	...
	"The_heading_in_english_is_required" => "The heading in english is required",
	"The_subheading_in_english_is_required" => "The subheading in english is required",
	"The_content_in_english_is_required" => "The content in english is required",
	"The_dealer_name_in_english_is_required" => "The dealer name in english is required",
	"The_location_in_english_is_required" => "The location in english is required",
	"The_year_is_required" => "The year field is required",
	...
	"Review_shipping_returns_refunds_privacy_and_service_terms_from_one_clear_policy_hub" => "Review shipping, returns, refunds, privacy, and service terms from one clear policy hub.",
	"active_policies" => "active policies",
	"Need_help_contact_us" => "Need help? Contact us",
	"Policy_summary_shipping" => "Delivery coverage, shipping timelines, and order dispatch expectations.",
	"Policy_summary_terms" => "Website usage rules, account responsibilities, and the legal terms that govern orders and services.",
	"Policy_summary_return" => "Return eligibility, conditions, and the steps required to send products back.",
	"Policy_summary_refund" => "Refund timing, payment reversal rules, and approval expectations.",
	"Policy_summary_cancellation" => "How and when orders can be cancelled before fulfillment progresses.",
	"Policy_summary_service" => "Service commitments, support coverage, and operating standards.",
	"Policy_summary_warranty" => "Warranty coverage scope, claim conditions, and the key terms for service eligibility.",
	"Policy_summary_privacy" => "How personal information is collected, processed, and protected.",
	"No_Policies_Available" => "No policies available",
	"We_are_currently_updating_our_policies_Please_check_back_soon" => "We are currently updating our policies. Please check back soon.",
	"Track_your_order" => "Track your order",
	"Enter_your_order_id_and_the_phone_number_used_during_checkout_to_view_the_latest_delivery_status" => "Enter your order ID and the phone number used during checkout to view the latest delivery status.",
	"Order_status_updates" => "Order status updates",
	"Use_the_same_phone_number_you_used_during_checkout_for_the_fastest_match" => "Use the same phone number you used during checkout for the fastest match.",
	"Before_you_start" => "Before you start",
	"Have_your_order_id_and_checkout_phone_number_ready" => "Have your order ID and checkout phone number ready.",
	"Guest_and_registered_customer_orders_can_be_tracked_from_here" => "Guest and registered customer orders can be tracked from here.",
	"If_you_enter_incorrect_details_the_system_will_not_find_the_order" => "If you enter incorrect details, the system will not find the order.",
	...
	"Choose your service type, confirm your details, and submit in one step." => "Choose your service type, confirm your details, and submit in one step.",
	"Visit the service center and complete the request there." => "Visit the service center and complete the request there.",
	"Confirmation" => "Confirmation",
	"I agree to the" => "I agree to the",
	"Service Policies" => "Service Policies",
	"and" => "and",
	"Select vehicle type" => "Select vehicle type",
	"Select from suggestions or type another make." => "Select from suggestions or type another make.",
	"Select from suggestions or type another model." => "Select from suggestions or type another model.",
	"Select from suggestions or type another state." => "Select from suggestions or type another state.",
	"Select from suggestions or type another city." => "Select from suggestions or type another city.",
	"Select from suggestions or type another area." => "Select from suggestions or type another area.",
	"Select from list or type manually." => "Select from list or type manually.",
	"Issue details" => "Issue details",
	"Problem description" => "Problem description",
	"Describe the issue, symptoms, or service needed." => "Describe the issue, symptoms, or service needed.",
	"Service expectations" => "Service expectations",
	"In-shop service" => "In-shop service",
	"Mobile service" => "Mobile service",
	"Share your exact service address and pin your location so the team can reach you faster." => "Share your exact service address and pin your location so the team can reach you faster.",
	"Map status" => "Map status",
	"Map available" => "Map available",
	"Map unavailable" => "Map unavailable",
	"Bring your vehicle details and issue summary." => "Bring your vehicle details and issue summary.",
	"Sign in first to submit your service request and track updates." => "Sign in first to submit your service request and track updates.",
	...
	"Type state if not available" => "Type state if not available",
	"Type city if not available" => "Type city if not available",
	"Type area if not available" => "Type area if not available",
	...
	"career_apply_modal_title" => "Apply for this role",
	"career_resume_label" => "Resume / CV",
	"career_notice_period_label" => "Notice period before you can start",
	"career_last_salary_label" => "Current or last salary",
	"career_resume_hint" => "Accepted file types: PDF, DOC, or DOCX. Maximum size: 2 MB.",
	"career_notice_period_hint" => "For example: Available immediately, 2 weeks, or 1 month.",
	"career_last_ctc_hint" => "Share your current or last salary only if you are comfortable doing so.",
	"Please_fill_out_this_field" => "Please fill out this field.",
	"Choose_how_you_want_to_receive_your_order" => "Choose how you want to receive your order.",
	"Deliver_to_my_address" => "Deliver to my address",
	"Collect_from_branch" => "Collect from branch",
	"Contact_Details" => "Contact details",
	"Enter_the_best_details_for_delivery_updates" => "Use the contact details where we should reach you about this order.",
	"Delivery_Choice" => "Delivery choice",
	"Choose_the_option_that_matches_how_you_want_to_receive_this_order" => "Pick delivery or branch pickup before completing the remaining fields.",
	"Address_Details" => "Address details",
	"Complete_only_the_fields_needed_for_your_selected_delivery_option" => "Only the fields related to your selected option will be required.",
	"Billing_Contact_Details" => "Billing contact details",
	"Use_details_for_invoices_and_billing_updates" => "Use the contact details that should receive billing and invoice updates.",
	"Billing_Address_Details" => "Billing address details",
	"Add_the_address_where_your_invoice_should_be_registered" => "Add the billing location that should appear on invoices and documents.",
	"Street_Address" => "Street address",
	"Provide_the_full_billing_address_for_documents_and_invoices" => "Provide the full billing address for invoices and billing records.",
	"Branches" => "Branches",
	"CRM Insights Report" => "CRM Insights Report",
	"Warranty Analytics Report" => "Warranty Analytics Report",
	"VOIP Insights Report" => "VOIP Insights Report",
	"Block" => "Block",
	...
	"bosta" => "Bosta",
	"Contact_details" => "Contact details",
	"Typical_reply_time_within_one_business_day" => "Typical reply time: within one business day",
	"You_can_call_email_or_send_a_message_here" => "You can call, email, or send a message here",
	"Find_a_branch" => "Find a branch",
	"Browse_branch_hours_locations_and_directions" => "Browse branch hours, locations, and directions.",
	"Best_phone_number_to_reach_you" => "Best phone number to reach you",
	"phone_number_example" => "Example: 01012345678",
	"Include_the_best_number_for_a_callback_or_whatsapp_if_available" => "Include the best number for a callback or WhatsApp if available.",
	"What_is_your_message_about" => "What is this message about?",
	"order_issue_branch_question_or_general_inquiry" => "Order issue, branch question, or general inquiry",
	"Use_a_short_clear_title_so_we_can_route_your_request_faster" => "Use a short, clear title so we can route your request faster.",
	"How_can_we_help" => "How can we help?",
	"Briefly_explain_your_request_and_include_any_order_branch_or_product_details" => "Briefly explain your request and include any order, branch, or product details.",
	"The_more_details_you_share_the_faster_we_can_help" => "The more details you share, the faster we can help.",
	"Quick_security_check" => "Quick security check",
	"Please_confirm_you_are_not_a_robot_before_sending_your_message" => "Please confirm you are not a robot before sending your message.",
	"Type_the_characters_from_the_image_then_send_your_message" => "Type the characters from the image, then send your message.",
	"Search_branches_by_name_address_location_or_phone" => "Search branches by name, address, area, or phone.",
	"Search_for_a_branch_name_address_location_or_phone_number" => "Search by branch name, address, area, or phone number",
	"Showing_branch_results_for" => "Showing branch results for",
	"No_branches_matched_your_search" => "No branches matched your search.",
	"Live_branch_map" => "Branch map",
	"Explore_branches_on_the_map" => "Explore branches on the map",
	"Tap_a_marker_to_view_branch_details_hours_and_directions" => "Tap a marker to view branch details, hours, and directions.",
	"Use_the_map_to_compare_nearby_branches_and_plan_your_visit" => "Use the map to compare branches and plan your visit.",
	"Available_now" => "Available now",
	"Currently_closed" => "Currently closed",
	"Open_in_google_maps" => "Open in Google Maps",
	"Contact_branch_directly" => "Contact branch",
	"We_are_here_to_help" => "We are here to help",
	"Send_your_question_and_we_will_route_it_to_the_right_team" => "Send your question and we will route it to the right team.",
	"Tell_us_how_we_can_help" => "Tell us how we can help",
	"Share_your_request_and_the_right_team_will_get_back_to_you" => "Share your request and the right team will get back to you.",
	"Choose_the_fastest_way_to_reach_us" => "Choose the fastest way to reach us",
	"Use_the_form_for_detailed_requests_or_choose_a_direct_channel_below" => "Use the form for detailed requests or choose a direct channel below.",
	"Need_a_quick_answer" => "Need a quick answer?",
	"For_faster_help_include_your_phone_order_or_branch_details_in_your_message" => "For faster help, include your phone number, order number, or branch details in your message.",
	"Stay_connected_with_us" => "Stay connected with us",
	"Follow_our_channels_for_updates_announcements_and_new_services" => "Follow our channels for updates, announcements, and new services.",
	"Executive_summary" => "Executive summary",
	"Who_we_are" => "Who we are",
	"Mission_and_direction" => "Mission and direction",
	...
	"Trusted_dealers" => "Trusted dealers",
	"Built_for_reliable_growth_and_long_term_partnerships" => "Built for reliable growth and long-term partnerships.",
	"Serving_customers_through_quality_reliability_and_long_term_partnerships" => "Serving customers through quality, reliability, and long-term partnerships.",
	"Trusted_partner_locations_across_key_markets" => "Trusted partner locations across key markets.",
	...
	"no_matching_dealers_found" => "No dealers match the selected filters.",
	...
	"Find_quick_answers_about_products_warranty_and_support_before_reaching_out_to_our_team" => "Find quick answers about products, warranty, and support before reaching out to our team.",
	"Support_answers_available" => "support answers available",
	"Explore_answers_or_contact_our_team_if_you_need_more_help" => "Explore the answers below or contact our team if you need more help.",
	"Find_your_warranty_record" => "Find your warranty record",
	"Enter_your_serial_number_and_the_contact_used_during_activation_to_view_warranty_status" => "Enter your serial number and the contact used during activation to view warranty status.",
	"Use_the_same_phone_or_email_linked_to_the_activation_record" => "Use the same phone number or email linked to the original activation.",
	"How_it_works" => "How it works",
	"Step_1" => "Step 1",
	"Step_2" => "Step 2",
	"Step_3" => "Step 3",
	"Need_to_activate_a_new_warranty" => "Need to activate a new warranty?",
	"If_OTP_verification_is_enabled_we_will_send_a_code_before_showing_the_record" => "If OTP verification is enabled, we will send a code before showing the record.",
	"Verify_your_access" => "Verify your access",
	"Enter_the_code_sent_to_your_registered_contact_to_continue_to_your_warranty_record" => "Enter the code sent to your registered contact to continue to your warranty record.",
	"Return_to_lookup" => "Return to lookup",
	"Activate_your_warranty" => "Activate your warranty",
	"Register_your_purchase_details_now_to_speed_up_future_support_claims_and_service_validation" => "Register your purchase details now to speed up future support, claims, and service validation.",
	"Need_to_check_an_existing_warranty" => "Need to check an existing warranty?",
	"Purchase_details" => "Purchase details",
	"Retailer_details" => "Retailer details",
	"Customer_details" => "Customer details",
	"Proof_and_consent" => "Proof and consent",
	"Have_these_ready_before_you_submit" => "Have these ready before you submit",
	"Serial_number_purchase_date_invoice_number_and_purchase_location" => "Serial number, purchase date, invoice number, and purchase location.",
	"Select_the_branch_or_enter_the_distributor_name_where_the_purchase_was_made" => "Select the branch or enter the distributor name where the purchase was made.",
	"Choose_an_official_branch_from_the_list" => "Choose an official branch from the list.",
	"Use_this_if_the_purchase_was_made_through_a_distributor_or_retail_partner" => "Use this if the purchase was made through a distributor or retail partner.",
	"A_clear_receipt_image_or_pdf_to_verify_the_purchase" => "A clear receipt image or PDF to verify the purchase.",
	"Use_a_phone_and_email_that_you_can_access_for_future_updates" => "Use a phone number and email that you can access for future updates.",
	"Warranty_services" => "Warranty services",
	"Choose_the_right_path_to_activate_a_new_warranty_review_an_existing_record_or_read_coverage_terms" => "Choose the right path to activate a new warranty, review an existing record, or read the coverage terms.",
	"Three_warranty_paths_available" => "Three warranty paths available",
	"Choose_your_next_step" => "Choose your next step",
	"Start_with_the_option_that_matches_your_current_need" => "Start with the option that matches your current need.",
	"Register_your_purchase_to_start_the_official_warranty_record" => "Register your purchase to start the official warranty record.",
	"Use_serial_number_and_registered_contact_to_check_status" => "Use your serial number and registered contact details to check the current warranty status.",
	"Review_the_policy_to_understand_coverage_terms_and_claim_requirements" => "Review the policy to understand coverage terms, exclusions, and claim requirements.",
	"Before_you_begin" => "Before you begin",
	"Have_your_serial_number_invoice_and_registered_contact_ready" => "Have your serial number, invoice details, and registered contact information ready.",
	"Claims_are_opened_from_inside_an_existing_warranty_record" => "Claims are opened from inside an existing warranty record after the product details are verified.",
	"If_you_need_branch_or_support_help_contact_our_team_directly" => "If you need help choosing a branch or understanding the process, contact our team directly.",
	"Browse_articles_updates_and_practical_guidance_from_NISR" => "Browse articles, updates, and practical guidance from NISR.",
	...
	"Manage_the_services_page_hero_catalogue_featured_selection_and_support_cards_from_one_screen" => "Manage the services page hero, catalogue, featured selection, and support cards from one screen.",
	...
	"Controls_the_service_page_hero_copy_and_primary_call_to_action" => "Controls the service page hero copy and primary call to action.",
	"Controls_the_quick_browse_services_intro_and_the_curated_service_selection" => "Controls the quick-browse services intro and the curated service selection.",
	"Controls_the_featured_services_intro_and_the_curated_featured_service_selection" => "Controls the featured services intro and the curated featured service selection.",
	"Controls_one_of_the_supporting_story_cards_displayed_lower_on_the_services_page" => "Controls one of the supporting story cards displayed lower on the services page.",
	"hero_section" => "Hero section",
	"hero_slides" => "Hero slides",
	"add_hero_slide" => "Add hero slide",
	"edit_hero_slide" => "Edit hero slide",
	"Hero_slide_added_successfully" => "Hero slide added successfully",
	"Hero_slide_updated_successfully" => "Hero slide updated successfully",
	"Hero_slide_deleted_successfully" => "Hero slide deleted successfully",
	...
	"Browse_products_by_priority_and_open_the_right_battery_family_faster" => "Browse products by priority and open the right battery family faster.",
	"Browse_services_by_priority_and_open_the_right_support_offer_faster" => "Browse services by priority and open the right support offer faster.",
	"Request_card_support" => "Support highlights",
	"Contact_our_team_for_sales_technical_or_service_guidance" => "Contact our team for sales, technical, or service guidance.",
	"Starting_from" => "Starting from",
	"Service_inclusions" => "Service inclusions",
	"Opening_this_item_will_take_you_to_the_detailed_page" => "Open the full service details",
	"No_showcase_products_available_right_now" => "No showcase products are available right now.",
	"No_showcase_services_available_right_now" => "No showcase services are available right now.",
	"Need_help_choosing_the_right_option" => "Need help choosing the right option?",
	"manage_catalogue_items" => "Manage catalogue items",
	"Curate_the_products_that_appear_in_each_catalogue_section_from_here" => "Curate the products that appear in each catalogue section from here.",
	"all_showcase_products" => "All showcase products",
	"assigned_products" => "Assigned products",
	"add_catalogue_product" => "Add catalogue product",
	"edit_section_content" => "Edit section content",
	"No_products_have_been_curated_for_this_section_yet" => "No products have been curated for this section yet.",
	"No_description_added_yet" => "No description added yet.",
	"open_full_product_editor" => "Open full product editor",
	"spec_file" => "Spec file",
	"related_material" => "Related material",
	"remove_from_section" => "Remove from section",
	"page_assets" => "Page assets",
	"Select_a_showcase_product_and_review_its_catalogue_assets_before_adding_it" => "Select a showcase product and review its catalogue assets before adding it.",
	"All_available_showcase_products_have_already_been_added" => "All available showcase products have already been added.",
	"This_product_is_already_added_to_another_catalogue_section" => "This product is already added to another catalogue section.",
	"Product_added_to_catalogue_section_successfully" => "Product added to the catalogue section successfully.",
	"Product_removed_from_catalogue_section_successfully" => "Product removed from the catalogue section successfully.",
	"Product_showcase" => "Product showcase",
	"Download_brochure" => "Download brochure",
	"Showcase_card_added_successfully" => "Showcase card added successfully.",
	"Showcase_card_updated_successfully" => "Showcase card updated successfully.",
	"Showcase_card_deleted_successfully" => "Showcase card deleted successfully.",
	"This_product_is_already_added_to_the_showcase_cards" => "This product is already added to the showcase cards.",
	...
	"Manage_the_public_products_catalogue_sections_and_curated_items_from_one_screen" => "Manage the public products catalogue sections and large showcase cards from one screen.",
	"hero_banner" => "Hero banner",
	"quick_browse_intro" => "Quick browse intro",
	"support_card_1" => "Support card 1",
	"support_card_2" => "Support card 2",
	"support_card_3" => "Support card 3",
	"featured_selection_intro" => "Showcase cards intro",
	"Controls_the_top_intro_of_the_products_catalogue_page" => "Controls the top hero banner of the public products catalogue page.",
	"Controls_the_quick_browse_intro_and_curated_product_shortcuts" => "Controls the quick browse intro and the shortcut products displayed under it.",
	...
	"Controls_the_featured_selection_intro_and_curated_products" => "Controls the large alternating showcase cards and their intro content.",
	...
	"Controls_the_main_hero_copy_and_single_image_for_the_products_page" => "Controls the main hero copy and the single supporting image for the products page.",
