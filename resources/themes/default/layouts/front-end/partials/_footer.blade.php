<div class="__inline-9 rtl">
    <div class="text-center pb-md-4">
        <div class="max-w-1160px mx-auto footer-container">
            <div class="container my-md-5 mt-4">
                <div class="row gx-3">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4 col-6  ">
                        <div class="about-company-card py-md-5 py-4">
                            <a href="{{ route('about-us') }}" class="d-block text-decoration-none">
                                <div class="d-flex justify-content-center text-primary">
                                    <img class="object-contain svg img-acfb" width="36" height="36"
                                        src="{{ theme_asset(path: 'public/assets/front-end/img/icons/about-us.svg') }}"
                                        alt="">
                                </div>
                                <div class="text-center">
                                    <p class="m-0 mt-2">{{ translate('about_us') }}</p>
                    ...
                    <div class="col-md-3 col-sm-6 mb-4 col-6  ">
                        <div class="about-company-card py-md-5 py-4">
                            <a href="{{ route('contacts') }}" class="d-block text-decoration-none">
                                <div class="d-flex justify-content-center text-primary">
                                    <img class="object-contain svg img-acfb" width="36" height="36"
                                ...
                                <div class="text-center">
                                    <p class="m-0 mt-2">{{ translate('contact_Us') }}</p>
                    ...
                    <div class="col-md-3 col-sm-6 mb-4 col-6 ">
                        <div class=" about-company-card py-md-5 py-4">
                            <a href="{{ route('helpTopic') }}" class="d-block text-decoration-none">
                                <div class="d-flex justify-content-center text-primary">
                                    <img class="object-contain svg img-acfb" width="36" height="36"
                                ...
                                <div class="text-center">
                                    <p class="m-0 mt-2">{{ translate('FAQ') }}</p>
                    ...
                    <div class="col-md-3 col-sm-6 mb-4 col-6  ">
                        <div class="about-company-card py-md-5 py-4">
                            <a href="{{ route('frontend.blog.index') }}" class="d-block text-decoration-none">
                                <div class="d-flex justify-content-center text-primary">
                                    <img class="object-contain svg img-acfb" width="36" height="36"
                                ...
                                <div class="text-center">
                                    <p class="m-0 mt-2">{{ translate('Blog') }}</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-6 footer-padding-bottom text-start">
                                ...
                                <ul class="widget-list __pb-10px">
                                    ...
                                    <li class="widget-list-item">
                                        <a class="widget-list-link" href="{{route('warranty.track.page')}}">
                                            {{ translate('warranty')}}
                                        </a>
                                    </li>
                                    <li class="widget-list-item">
        ...
        <div class="bg-white-overlay-50">
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align text-center pt-3 pb-4 py-md-0">
                    <div class="mt-3">
                        <p class="__text-16px">{{ getWebConfig(name: 'company_copyright_text') ?? $web_config['copyright_text'] }}</p>
                    </div>
                    <div
