        ...
        @else
            <tr>
                ...
                <td class="text-end border-bottom" style="padding:23px 16px">
                    ...
                    <div class="fz-17 text-primary text-end">{{ webCurrencyConverter(amount: $orderTotalPriceSummary['totalAmount']) }}</div>
                </td>
            </tr>
        @endif
        <tr>
                    ...
                    @foreach($order->details as $key=>$details)
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="fz-10">
                                     @if($details->exchange_qty > 0 && $details->exchange_charges > 0)
                                        <br>
                                        {{ translate('Exchange')}} :  {{$details->exchange_qty}} * {{ webCurrencyConverter(amount: $details->exchange_charges) }}
                                    @endif
                                </div>
                            </td>
                            <td class="text-end">
                            ...
                            <td class="text-end">
                                <div class="fz-10 text-dark">{{ webCurrencyConverter(amount: $details['installtion_charges'] * $details['qty']) }}</div>
                            </td>
                            <td class="text-end">
                                <div class="fz-10 text-dark">
                                    {{ webCurrencyConverter(amount: $details['price'] * $details['qty']  + ($details['installtion_charges'] * $details['qty'])) }}
                                </div>
                            </td>
                        </tr>
                            <?php
                    ...
                    <tr>
                        ...
                        <th class="calc-table">
                            <table>
                                <tbody>
                                <tr>
                                    <td class="text-start font-bold">{{ translate('total_Item_Price')}}</td>
                                    <td class="text-end">
                                        {{ webCurrencyConverter(amount: $orderTotalPriceSummary['itemPrice']) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-start font-bold">{{ translate('product_Discount')}}</td>
                                    <td class="text-end">
                                        - {{ webCurrencyConverter(amount: $orderTotalPriceSummary['itemDiscount']) }}</td>
                                </tr>
                                @if($orderTotalPriceSummary['totalExchangePrice'] > 0)
                                <tr>
                                    <td class="text-start font-bold">{{ translate('Exchange_Service')}}</td>
                                    <td class="text-end">
                                        - {{ webCurrencyConverter(amount: $orderTotalPriceSummary['totalExchangePrice']) }}</td>
                                </tr>
                                @endif
                                @if ($order->order_type != 'default_type')
                                    <tr>
                                        <td class="text-start font-bold">{{ translate('extra_Discount')}}</td>
                                        <td class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ webCurrencyConverter(amount: $orderTotalPriceSummary['subTotal']) }}</td>
                                </tr>

                                @if($order->order_type == 'default_type' && $order?->is_shipping_free != 1)
                                    <tr>
                                        <td class="text-start font-bold">{{ translate('shipping')}}</td>
                                        <td class="text-end">{{webCurrencyConverter(amount: $orderTotalPriceSummary['shippingTotal']) }}</td>
                                    </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ webCurrencyConverter(amount: $orderTotalPriceSummary['taxTotal']) }}</td>
                                </tr>
                                <tr>
