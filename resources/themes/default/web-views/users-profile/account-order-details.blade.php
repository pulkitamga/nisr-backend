                                                        ...
                                                        <div class="d-flex flex-wrap gap-2 mt-2">
                                                            ...
                                                            @endif
                                                                ...
                                                                @if( $length <= $refund_day_limit && $detail->refund_request == 0)
                                                                    ...
                                                                    <br>
                                                                    <small class="fs-12 text-secondary-50">
                                                                        <span class="font-bold">{{translate('Exchange')}} : </span>
                                                                        <span class="font-semi-bold">{{$detail->exchange_qty}} * {{ webCurrencyConverter(amount: $detail->exchange_charges) }}</span>
                                                                    </small>
                                                                    @endif
                                    ...
                                    <table class="calculation-table table table-borderless mb-0">
                                        <tbody class="totals">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="text-start">
                                                        <span class="product-qty ">{{translate('exchange_Service')}}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-end">
                                                        <span class="fs-15 font-semi-bold">
                                                            {{ webCurrencyConverter(amount: $orderTotalPriceSummary['totalExchangePrice']) }}
                                                        </span>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rtl">
            ...
            <div class="modal-body">
                <form id="activateWarrantyForm" action="{{ route('warranty.activate.order.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-3">
                        ...
                        <button type="submit" class="btn btn--primary">{{ translate('Activate Warranty') }}</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $(document).on('click', '.activate-warranty-btn', function() {
        ...
        $('#orderDetailId').val(detailId); // <-- ID feed ho gaya!
        $('#activateWarrantyModal').modal('show');
    });
</script>
@endpush
