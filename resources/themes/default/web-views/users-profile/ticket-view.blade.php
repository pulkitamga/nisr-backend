            ...
            <div class="__card">
                <div class="card-header border-0 p-2 p-sm-3">
                    <div class="bg-section rounded d-flex gap-2 align-items-start justify-content-between p-3 ">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="meta-info d-flex flex-wrap align-items-center column-gap-4 fs-14 mt-2">
                                        <div class="d-flex align-items-center gap-2 gap-md-3">
                                            ...
                                            'close', 'closed' => 'text-success',
                                            default => 'text-star',
                                            };
                                            @endphp
                                            <span class="{{ $statusClass }} fw-semibold">{{ $statusName }}</span>
                                            @else
                                            <span class="text-secondary fw-semibold">{{ translate('unknown') }}</span>
                                            @endif
                                        </div>
                        ...
                        @if($ticket->status_details && strtolower($ticket->status_details->name) != 'closed')
                        <a href="{{ route('support-ticket.close', [$ticket['id']]) }}" class="btn btn-sm fs-14 font-semibold text-capitalize btn-outline-danger d-none d-sm-inline-block">
                            {{ translate('close_this_ticket') }}
                        </a>
                        <a href="{{ route('support-ticket.close', [$ticket['id']]) }}" class="btn btn-outline-success btn-sm d-sm-none">
                            {{ translate('close') }}
                        </a>
                        @endif
                    </div>
                    ...
                    <div class="media gap-3">
                        <div class="media-body d-flex">
                            ...
                            <img class="rounded-circle __img-40 mt-2 text-align-direction" alt=""
                                src="{{ $admin ? getStorageImages(path: $admin->image_full_url, type: 'avatar') : getStorageImages(path: null, type: 'avatar') }}">
