<section class="pt-4 pt-lg-5">
    <div class="container">
         <div class="d-flex flex-column gap-2 align-items-center text-center">
            ...
            <p class="max-w-500 mb-4">{{translate('got_questions_about_becoming_a_wholesaler').' ?
                '.translate('explore_our_wholesaler_FAQ_section_for_answers_to_any_queries_you_may_have_about_joining_our_platform_as_a_wholesaler')}}
            </p>
        </div>
