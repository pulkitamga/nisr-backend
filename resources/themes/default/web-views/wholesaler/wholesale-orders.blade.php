            ...
            <div class="card __card web-direction customer-profile-orders h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="font-bold mb-0 fs-16">{{ translate('my_Wholesale_Orders') }}</h5>
                    </div>
                        ...
                        <table class="table __table __table-2 text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    return ($item->product_quantity ?? 0) * ($item->base_price ?? 0);
                                    });
                                    @endphp
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <strong>{{ webCurrencyConverter($totalAmount) }}</strong>

                                    </td>

                                    <td>
                                        <a href="{{ route('wholesale.account.order.detail', $order->id) }}"
                                            class="btn-outline--info text-base p-1 btn-shadow rounded-full"
