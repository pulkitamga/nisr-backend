                            ...
                            <div class="col-12">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="signup" role="tabpanel">
                                        <form class="needs-validation_"
                                              autocomplete="off"
                                              novalidate
                                              id="sign-up-form"
                                              action="{{ route('customer.auth.register') }}"
                                              method="post">
                                            @csrf
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="su-f-name">{{ translate('first_name') }}</label>
                                                        <input class="form-control"
                                                               type="text"
                                                               name="f_name"
                                                               id="su-f-name"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="su-l-name">{{ translate('last_name') }}</label>
                                                        <input class="form-control"
                                                               type="text"
                                                               name="l_name"
                                                               id="su-l-name"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="su-phone">{{ translate('phone') }}</label>
                                                        <input class="form-control"
                                                               name="phone"
                                                               type="number"
                                                               id="su-phone"
                                                               placeholder="{{ translate('01700000000') }}"
                                                               required>
                                                        <div class="invalid-feedback">
