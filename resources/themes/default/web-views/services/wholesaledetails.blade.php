...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        quantityInput.addEventListener('blur', checkQuantity); // only on input blur
        quantityInput.addEventListener('input', validateSilently); // just disables/enables
        ...
        @else
        // ✅ MOQ override: allow any quantity >= 1
        window.changeQuantity = function (amount) {
            let currentQty = parseInt(quantityInput.value) || 0;
            let newQty = currentQty + amount;
