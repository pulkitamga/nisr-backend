        ...
        <table class="fz-10 border bs-0"  style="border-radius:12px;background:#F3F7FF;border-color:#D6EBFF">
            ...
            <tr>
                <td class="text-start" style="padding:23px 16px">
                    ...
                    <div class="mb-1 fz-10">
                        <span class="font-bold">{{ translate('date')}}</span> : <span class="font-normal">{!! formatDateTimeForDisplay($order['created_at'], 'M d ,Y') !!}</span>
                    </div>
                </td>
        ...
        <table class="fz-10">
            <tr>
                <td style="padding:0;text-align:{{$direction === "rtl" ? 'right' : 'left'}}">
                    ...
                    <div class="font-normal">
                        <strong>{{ translate('invoice_Date')}}</strong> : {!! formatDateTimeForDisplay($order['created_at'], 'M d ,Y') !!}
                    </div>
                </td>
