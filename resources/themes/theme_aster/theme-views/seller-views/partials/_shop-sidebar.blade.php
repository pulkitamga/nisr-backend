...
<div>
    <h6 class="mb-3">{{ translate('make') }}</h6>
    <select id="make-select" name="make" class="form-control form-control--sm">
...
<div>
    <h6 class="mb-3">{{ translate('model') }}</h6>
    <select id="model-select" name="model" class="form-control form-control--sm" disabled>
        <option value="">{{ translate('Select Model') }}</option>
    </select>
</div>

<div>
    <h6 class="mb-3">{{ translate('year') }}</h6>
    <select id="year-select" name="year" class="form-control form-control--sm" disabled>
